...
describe("openapi-registry", () => {
  ...
  describe("registerRoutes", () => {
    ...
    it("should register GET route without auth", () => {
      ...
      const getOperation = schema.paths["/items"].get as Record<
        string,
        unknown
      >;
    ...
    it("should register POST route with request body", () => {
      ...
      const postOperation = schema.paths["/items"].post as Record<
        string,
        unknown
      >;
    ...
    it("should register route with path parameters", () => {
      ...
      const getOperation = schema.paths["/users/{userId}"].get as Record<
        string,
        unknown
      >;
      expect(getOperation).toBeDefined();
    ...
    it("should register route with multiple response codes", () => {
      ...
      const getOperation = schema.paths["/users/{userId}"].get as Record<
        ...
        unknown
      >;
      const responses = getOperation.responses as Record<
        string,
        { description: string }
      >;
    ...
    it("should register route with JWT auth handler", () => {
      ...
      const jwtHandler = bearerAuth("jwtAuth", ["read:users"])((
        _req,
        _res,
        next,
      ) => {
    ...
    it("should register route with API key auth handler", () => {
      ...
      const postOperation = schema.paths["/items"].post as Record<
        ...
        unknown
      >;
      const security = postOperation.security as Array<
